...
class Feedback:
    def __init__(self, master):
        ...
        self.style.configure('Head.TLabel',background='#e1d8b9', font=('Arial',18,'bold'))
        ...
        ttk.Label(self.frame_header, text='Thanks for Exploring!',style='Head.TLabel').grid(row=0, column=1)
        ttk.Label(self.frame_header, wraplength=300,
                  text="We're glad you chose Explore California for you recent adventure. "
                       "Please tell use what you thought about the 'Desert to Sea' tour.").grid(row=1, column=1)

        self.frame_content = ttk.Frame(master)
        self.frame_content.pack()

        ttk.Label(self.frame_content, text='Name:').grid(row=0, column=0, padx=5, stick='sw')
